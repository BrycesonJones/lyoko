    ...
    <div className={cn("w-full bg-background text-foreground p-8", className)}>
      <div className="max-w-4xl mx-auto">
        ...
        <div className="text-center mb-12 md:mb-16">
          ...
          <h1 className="font-sans text-4xl md:text-5xl font-normal mb-2 tracking-tight">{title}</h1>
          {subtitle && (
            <h2 className="font-sans text-xl md:text-2xl font-normal text-muted-foreground">{subtitle}</h2>
          )}
        </div>
